...
import net.voxton.voxtongen.support.SurroundingParks;
...
public class PlatPark extends PlatLot {
    ...
    protected final static byte cisternId = (byte) Material.DOUBLE_STEP.getId();
    ...
    protected final static Material ledgeMaterial = Material.DOUBLE_STEP;
